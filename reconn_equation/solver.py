...
def load_model():
    with open("C:/Users/WIN/Desktop/Project/SolveurEquations/reconn_equation/solver_model.json", 'r') as json_file:
        solver_model = model_from_json(json_file.read())
    solver_model.load_weights("C:/Users/WIN/Desktop/Project/SolveurEquations/reconn_equation/solver_model_weights.h5")
    return solver_model
...
def extract(img):
    ...
    segmented_symbols = segmentation.segment_image(img)
...
def extract_linear_equations(img):
    lines = segmentation.segment_lines(img)
