...
# '+' - 10
data_plus = load_symbol_dataset(r"C:\Users\hetvi.LENOVO--520\Solving Handwritten Mathematical Equations Using Neural Network Techniques\Data\+")
data_plus = np.insert(data_plus, 784, 10, axis=1)
print(data_plus.shape)

# '-' - 11
data_minus = load_symbol_dataset(r"C:\Users\hetvi.LENOVO--520\Solving Handwritten Mathematical Equations Using Neural Network Techniques\Data\-")
data_minus = np.insert(data_minus, 784, 11, axis=1)
print(data_minus.shape)

# '*' - 12
data_times = load_symbol_dataset(r"C:\Users\hetvi.LENOVO--520\Solving Handwritten Mathematical Equations Using Neural Network Techniques\Data\times")
data_times = np.insert(data_times, 784, 12, axis=1)
print(data_times.shape)

# '=' - 13
data_equal = load_symbol_dataset(r"C:\Users\hetvi.LENOVO--520\Solving Handwritten Mathematical Equations Using Neural Network Techniques\Data\=")
data_equal = np.insert(data_equal, 784, 13, axis=1)
print(data_equal.shape)

# 'x' = 14
data_x = load_symbol_dataset(r"C:\Users\hetvi.LENOVO--520\Solving Handwritten Mathematical Equations Using Neural Network Techniques\Data\X")
data_x = np.insert(data_x, 784, 14, axis=1)
print(data_x.shape)

# 'y' = 15
data_y = load_symbol_dataset(r"C:\Users\hetvi.LENOVO--520\Solving Handwritten Mathematical Equations Using Neural Network Techniques\Data\y")
